    ...
    return (
        <div className="datatable-filter-demo">
            <div className="card">
                ...
                <DataTable value={customers1} paginator className="p-datatable-customers" showGridlines rows={5}
            ...
            {/*    <DataTable value={customers2} paginator className="p-datatable-customers" rows={5}*/}
